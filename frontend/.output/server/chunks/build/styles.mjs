...
const styles = {
  ...
  "pages/index.vue": () => import('./index-styles.Cs1u18sl.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=0&scoped=4d960afb&lang.css": () => import('./index-styles.4TNEiTWR.mjs').then(interopDefault)
};

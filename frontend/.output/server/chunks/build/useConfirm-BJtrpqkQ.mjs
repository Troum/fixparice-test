import { f as useToast, r as useOverlay, d as _sfc_main$9, c as _sfc_main$e, i as useLocale, h as useAppConfig, j as usePortal, t as tv } from './server.mjs';
import { ref, defineComponent, mergeProps, withCtx, createVNode, unref, toDisplayString, useSlots, toRef, computed, renderSlot, toHandlers, createTextVNode, createBlock, createCommentVNode, openBlock, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrInterpolate, ssrRenderSlot, ssrRenderClass } from 'vue/server-renderer';
...
function useUI() {
  ...
  async function showModal2(component, props = {}) {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "ConfirmationModalComponent",
  __ssrInlineRender: true,
  emits: ["close"],
  setup(__props, { emit: __emit }) {
    const { params: params2 } = useConfirm();
    const emits = __emit;
    ...
    const doAction = async () => {
      ...
      try {
        await Promise.resolve(params2.value.action());
        await sleep(150);
        emits("close", true);
      } finally {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UModal, mergeProps({ ui: { header: "flex items-center gap-0 sm:p-0 min-h-16", footer: "flex items-center gap-0 sm:p-0 min-h-16" } }, _attrs), {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center justify-between w-full px-5 py-3 border-b border-gray-200/70 dark:border-gray-800/70 bg-gradient-to-r from-rose-50 to-transparent dark:from-rose-950/20"${_scopeId}><div class="flex items-center gap-3"${_scopeId}><div class="inline-flex h-10 w-10 items-center justify-center rounded-full bg-rose-100 text-rose-600 ring-1 ring-rose-200/60 dark:bg-rose-400/10 dark:text-rose-400 dark:ring-rose-400/20" aria-hidden="true"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UIcon, {
              name: "i-mdi-alert-circle-outline",
              class: "h-6 w-6"
            }, null, _parent2, _scopeId));
            _push2(`</div><p class="text-base font-semibold tracking-tight text-gray-900 dark:text-gray-100"${_scopeId}>${ssrInterpolate(unref(params2).title)}</p></div>`);
            _push2(ssrRenderComponent(_component_UButton, {
              ...
              size: "sm",
              "aria-label": "Закрыть",
              onClick: ($event) => emits("close", false)
            }, null, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", { class: "flex items-center justify-between w-full px-5 py-3 border-b border-gray-200/70 dark:border-gray-800/70 bg-gradient-to-r from-rose-50 to-transparent dark:from-rose-950/20" }, [
                createVNode("div", { class: "flex items-center gap-3" }, [
                  ...
                  createVNode("p", { class: "text-base font-semibold tracking-tight text-gray-900 dark:text-gray-100" }, toDisplayString(unref(params2).title), 1)
                ]),
        ...
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="px-2 py-5"${_scopeId}><p class="text-sm leading-relaxed text-gray-600 dark:text-gray-300"${_scopeId}>${ssrInterpolate(unref(params2).message)}</p></div>`);
          } else {
            return [
              createVNode("div", { class: "px-2 py-5" }, [
                createVNode("p", { class: "text-sm leading-relaxed text-gray-600 dark:text-gray-300" }, toDisplayString(unref(params2).message), 1)
              ])
            ];
          }
        }),
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center justify-end gap-3 w-full px-6 py-4"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UButton, {
              variant: "ghost",
              color: "neutral",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span class="font-medium"${_scopeId2}>Отменить</span></span>`);
                } else {
                  return [
                    createVNode("span", { class: "flex items-center gap-2" }, [
                      ...
                      createVNode("span", { class: "font-medium" }, "Отменить")
                    ])
                  ];
                }
              }),
            ...
            _push2(ssrRenderComponent(_component_UButton, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span class="font-semibold"${_scopeId2}>${ssrInterpolate(unref(params2).label)}</span></span>`);
                } else {
                  return [
                    createVNode("span", { class: "flex items-center gap-2" }, [
                      createVNode(_component_UIcon, {
                      ...
                      createVNode("span", { class: "font-semibold" }, toDisplayString(unref(params2).label), 1)
                    ])
                  ];
                }
              }),
            ...
            return [
              createVNode("div", { class: "flex items-center justify-end gap-3 w-full px-6 py-4" }, [
                createVNode(_component_UButton, {
                  variant: "ghost",
                  color: "neutral",
                  disabled: isProcessing.value,
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ConfirmationModalComponent.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Confirmation = Object.assign(_sfc_main, { __name: "ConfirmationModalComponent" });
const params = ref({
  title: "Title",
  message: "Description",
  label: "Confirm",
...
const useConfirm = () => {
  async function confirm(title, message, label, action) {
    ...
    await showModal(Confirmation, params);
  }
  function confirmDelete(title = "Удалить запись?", description = "Вы действительно хотите удалить запись?", confirmText = "Удалить", onConfirm, successMessage = "Запись удалена успешно", errorMessage = "Не удалось удалить запись") {
...
//# sourceMappingURL=useConfirm-BJtrpqkQ.mjs.map

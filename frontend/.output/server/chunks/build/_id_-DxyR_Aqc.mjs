...
import { _ as _sfc_main$2 } from './Badge-GHH234is.mjs';
import { _ as _sfc_main$3 } from './Select-VTHFZR89.mjs';
import { defineComponent, ref, watchEffect, mergeProps, unref, withCtx, createTextVNode, createVNode, toDisplayString, createBlock, createCommentVNode, openBlock, isRef, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen p-4" }, _attrs))}><div class="max-w-4xl mx-auto"><div class="mb-6">`);
              ...
              return [
                createVNode("div", { class: "flex justify-between items-start" }, [
                  ...
                  createVNode("div", { class: "flex gap-2" }, [
                    unref(canUpdateVacancies) ? (openBlock(), createBlock(_component_UButton, {
                      key: 0,
                      icon: "i-lucide-edit",
                      color: "blue",
                      variant: "outline",
                    ...
                    unref(canDeleteVacancies) ? (openBlock(), createBlock(_component_UButton, {
                      key: 1,
                      icon: "i-lucide-trash",
                      color: "red",
                      variant: "outline",
...
//# sourceMappingURL=_id_-DxyR_Aqc.mjs.map

import { e as useRoute, a as useRouter, f as useToast, g as useApi, d as _sfc_main$9 } from './server.mjs';
import { _ as __nuxt_component_2, a as _sfc_main$1$1, b as _sfc_main$3, c as _sfc_main$4 } from './Pagination-Dc1EGt2v.mjs';
import { _ as _sfc_main$1 } from './Card-C_IdJI02.mjs';
import { _ as _sfc_main$2 } from './Select-VTHFZR89.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const { usePaginatedData, deleteVacancy, updateVacancy } = useApi();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-w-screen min-h-screen p-4" }, _attrs))}><div class="mb-6 flex justify-between items-center"><h1 class="text-2xl font-bold">Управление вакансиями</h1>`);
      _push(ssrRenderComponent(_component_UserInfo, null, null, _parent));
      _push(`</div>`);
      if (unref(stats) && unref(canViewStats)) {
          ...
          if (_push2) {
            ...
            if (unref(canCreateVacancies)) {
              _push2(ssrRenderComponent(unref(UButton), {
                icon: "i-lucide-plus",
                onClick: ($event) => unref(router).push("/jobs/create")
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(` Создать вакансию `);
                  } else {
                    return [
...
//# sourceMappingURL=index-C6IvJ9Hi.mjs.map
